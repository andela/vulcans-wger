...
user_parser.add_argument('--add-to-gym',
                         action='store',
                         default='auto',
                         help='Gym to assign the users to. Allowed values: auto,'
                         'none, <gym_id>. '
                              'Default: auto')
user_parser.add_argument('--country',
                         action='store',
                         default='germany',
                         help='What country the generated users should belong '
                         'to. Default: Germany',
            ...
            for j in range(0, total_meals):
                ...
                for k in range(0, random.randint(1, 5)):
                    ...
                    meal_item = MealItem(meal=meal, ingredient=ingredient,
                                         weight_unit=None, order=order, amount=random.randint(
                                             10, 250))
                    meal_item.save()
                order = order + 1
